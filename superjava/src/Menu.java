...
public class Menu extends JFrame implements ActionListener {
	...
	JMenuItem add1 = new JMenuItem("增加学生 ");
	JMenuItem updata1 = new JMenuItem("修改学生信息");
	JMenuItem delete1 = new JMenuItem("删除学生");
	JMenu m2 = new JMenu("课程管理");
	JMenuItem add2 = new JMenuItem("增加课程");
	JMenuItem updata2 = new JMenuItem("修改课程   ");
	JMenuItem delete2 = new JMenuItem("删除课程");
	JMenu m3 = new JMenu("选课管理");
	JMenuItem add3 = new JMenuItem("增加选课课程 ");
	JMenuItem updata3 = new JMenuItem("修改选课课程   ");
	JMenuItem delete3 = new JMenuItem("删除选课课程  ");
